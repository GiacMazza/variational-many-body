MODULE GZ_VARS_GLOBAL
  ...
  real(8),public,allocatable                :: local_hamiltonian_free(:,:)       ! free Hamiltonian of the atomic problem
  ...
  real(8),public,allocatable                :: phi_traces_basis_free_Hloc(:,:)     ! Single matrix of dimension (nFock X nFock) 
!  real(8),public,allocatable                :: GZproj_vect(:)                 ! dimension nFock
  ...
  real(8),public,allocatable                :: GZ_opt_Rhop(:,:)         ! reormalization factors 
  ...
  real(8),public,allocatable                :: gz_dens_dens_orb(:,:)  ! density_density different orbitals (1:Norb,1:Norb)
  ...
  real(8),public,allocatable                :: dens_dens_orb(:,:,:,:)     ! local density    (Norb,Norb,:,:)
