MODULE GZ_neqAUX_FUNX
  ...
  public :: read_optimized_variational_wf_normal_imt,read_optimized_variational_wf_normal_imt_
...
CONTAINS
  ...
  subroutine read_optimized_variational_wf_normal_imt_(read_dir,Hqp,phi_vector)
    character(len=200)             :: read_dir
    complex(8),dimension(Nphi)     :: phi_vector
  ...
  end subroutine read_optimized_variational_wf_normal_imt_
  ...
  subroutine read_optimized_variational_wf_normal_imt(read_dir,Hqp,phi_vector)
    character(len=200)             :: read_dir
    complex(8),dimension(Nphi)     :: phi_vector
