!THIS IS A MODIFIED WRAPPER (AA & F.GRANDI) FOR THE LANCELOT SOLVER.
!IN THIS VERSION WE TOOK RID OF PROBFUN AS WE ARE SPECIFYING DIRECTLY 
!THE FUNCTION TO MINIMIZE IN THE INPUT OF LANCELOT_SIMPLE PROCEDURE.


MODULE LANCELOT_WRAP
  PRIVATE
