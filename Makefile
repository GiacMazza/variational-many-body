...
#OBJS=AMOEBA.o GZ_VARS_INPUT.o GZ_VARS_GLOBAL.o  GZ_AUX_FUNX.o GZ_LOCAL_FOCK_SPACE.o GZ_VARIATIONAL_BASIS.o GZ_EFFECTIVE_HOPPINGS.o GZ_PROJECTORS_TRACE.o GZ_ENERGY_MINIMIZATION.o GZ_OPTIMIZED_ENERGY.o
