program GUTZ_mb
  ...
  !
  real(8) :: tmp_emin,Uiter,tmp_ene,orb_pol,tmp_real,Jh_ratio,Jiter,search_mu
  ...
  do i=1,Nsweep
     ...
     if(nread/=0.d0) then
        ...
        write(*,*) R_init
        write(*,*) 
        n1=gz_optimized_density_VS_xmu(xmu1)
        !
        write(*,*) 
        write(*,*) R_init
        write(*,*) 
        n2=gz_optimized_density_VS_xmu(xmu2)
