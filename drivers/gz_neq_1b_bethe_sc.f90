program GUTZ_mb
  ...
  real(8) :: bcs_Kenergy,bcs_Uenergy
  ...
  do it=1,Nt
     ...
     if(mod(it-1,nprint).eq.0) then        
        ...
        write(unit_neq_bcs,'(10F18.10)') t,bcs_sc_order,bcs_Kenergy+bcs_Uenergy,bcs_Kenergy,bcs_Uenergy
        !
     end if
     !
